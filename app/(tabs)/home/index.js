...
const index = () => {
  ...
  const addTodo = async () => {
    try {
      ...
      axios
        .post("http://192.168.0.105:3000/todos/65f17e384707a9a773a8217e", todoData)
        .then((response) => {
  ...
  const getUserTodos = async () => {
    try {
      const response = await axios.get(
        ...
        `http://192.168.0.105:3000/users/65f17e384707a9a773a8217e/todos`
      );
  ...
  const markTodoAsCompleted = async (todoId) => {
    try {
      ...
      const response = await axios.patch(
        `http://192.168.0.105:3000/todos/${todoId}/complete`
      );
