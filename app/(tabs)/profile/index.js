...
const index = () => {
  ...
  const fetchTaskData = async () => {
    try {
      const response = await axios.get("http://192.168.0.105:3000/todos/count");
    ...
    <View style={{ padding: 10, flex: 1, backgroundColor: "white" }}>
      <View style={{ flexDirection: "row", alignItems: "center", gap: 10 }}>
        <Image
          ...
          source={{
            uri: "https://lh3.googleusercontent.com/a/ACg8ocIZFqZwfpzRuxc_NR-f6zoJqpDOoaP02C4mzbOSlPUYA14=s96-c-rg-br100",
          }}
        />
        <View>
